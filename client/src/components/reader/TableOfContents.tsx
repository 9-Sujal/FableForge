...
export default function TableOfContents({ data, visible, onClick }: Props) {
  return (
    <div
      style={{ right: visible ? "0" : "-100%" }}
      className="dark:bg-book-dark dark:text-book-dark transition-all md:w-96 w-3/4 bg-slate-950 h-screen overflow-y-scroll fixed z-50 top-0 right-0 flex flex-col space-y-3 p-3 shadow-md"
    >
